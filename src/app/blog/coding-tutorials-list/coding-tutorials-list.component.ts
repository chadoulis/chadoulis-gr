...
@Component({
  selector: 'app-coding-tutorials-list',
  templateUrl: './coding-tutorials-list.component.html',
  styleUrls: ['./coding-tutorials-list.component.scss']
})
export class CodingTutorialsListComponent implements OnInit {
